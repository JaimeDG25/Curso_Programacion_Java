...
public class Formulario extends javax.swing.JFrame {
    ...
    private List<Acceso> porfa= new ArrayList<Acceso>();
    ...
    private void btn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn2ActionPerformed
        ...
        op.setNombre(this.txt1.getText());
        op.setApellido(this.txt2.getText());
        
        if(txt1.getText().isEmpty()||txt2.getText().isEmpty()){
            JOptionPane.showMessageDialog(rootPane, "Rellene los campos");
        }else{
            //como saber si utilizamos un insert o un uptade al presionar el boton
            //si no esta vacio la caja de id, asignale ese valor que esta
            /*if(!txtId.getText().equals("")){
                c1.setId(txtId.getText());
            }*/
